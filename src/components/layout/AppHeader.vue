    ...
    <nav class="container-custom">
      <div class="flex items-center justify-between">
        ...
        <router-link to="/" class="flex items-center gap-2" @click="closeMobileMenu">
          <div class="w-45 h-12 rounded-lg flex items-center justify-center bg-white p-1">
            <img src="/logo.jpeg" alt="Ferray Digital Group" class="w-full h-full object-contain" />
          </div>
        </router-link>
        ...
        <div class="hidden md:block">
          <router-link to="/contact" class="btn-primary text-sm"> Devis gratuit </router-link>
        </div>
      ...
      >
        <div class="flex flex-col gap-4">
          ...
          <router-link to="/contact" class="btn-primary text-center mt-2" @click="closeMobileMenu">
            Devis gratuit
          </router-link>
        </div>
      </div>
