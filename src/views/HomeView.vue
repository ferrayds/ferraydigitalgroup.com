...
<template>
  <div>
    ...
    <section class="relative min-h-screen flex items-center bg-dark-900 overflow-hidden">
      ...
      <div class="container-custom relative z-10 pt-24 pb-16">
        <div class="max-w-4xl">
          ...
          >
            <span class="inline-block px-4 py-2 bg-primary-600/20 text-primary-400 rounded-full text-sm font-medium mb-6">
              🚀 Transformation digitale pour entreprises
            </span>
          </div>
          ...
          >
            Ferray Digital Group est votre partenaire de confiance pour la création 
            de logiciels sur mesure, solutions SaaS et transformations digitales.
          </p>
          ...
          >
            ...
            <AppButton to="/portfolio" variant="secondary" size="lg" class="!border-white !text-white hover:!bg-white/10">
    ...
    <AppSection>
      <div class="text-center mb-12">
        ...
        <p class="section-subtitle mx-auto">
          Une expertise complète pour répondre à tous vos besoins digitaux
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center mb-4 group-hover:bg-primary-600 transition-colors">
            <svg class="w-6 h-6 text-primary-600 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path v-if="service.icon === 'lightbulb'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
              <path v-else-if="service.icon === 'code'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/>
              <path v-else-if="service.icon === 'cloud'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"/>
              <path v-else-if="service.icon === 'credit-card'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
              <path v-else stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"/>
            </svg>
          </div>
          <h3 class="text-lg font-semibold text-dark-900 mb-2 group-hover:text-primary-600 transition-colors">
            {{ service.title }}
          </h3>
        ...
        >
          <div class="w-14 h-14 rounded-xl bg-primary-600/20 flex items-center justify-center mx-auto mb-4">
            <svg class="w-7 h-7 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path v-if="item.icon === 'trophy'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
              <path v-else-if="item.icon === 'agile'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
              <path v-else-if="item.icon === 'support'" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/>
    ...
    <AppSection>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="relative overflow-hidden rounded-2xl aspect-[4/3] mb-4">
            ...
            />
            <div class="absolute inset-0 bg-dark-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
              <AppButton to="/portfolio" variant="primary" size="sm">
                Voir le projet
              </AppButton>
            </div>
          </div>
          <div class="px-2">
            ...
            <h3 class="text-lg font-semibold text-dark-900 mt-1 group-hover:text-primary-600 transition-colors">
              {{ project.title }}
            </h3>
      ...
      <div class="text-center mt-12">
        <AppButton to="/portfolio" variant="secondary">
      ...
      <div class="container-custom relative z-10">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="text-gray-300 text-lg mb-10">
            Discutons de vos besoins et concevons ensemble la solution parfaite pour votre entreprise.
          </p>
